 ...
 */
 ...
 require("./tasks/price-converter")
 require("./tasks/random-crypto-marc")
 require("./tasks/market-item")
 ...
 const PRIVATE_KEY_DEV = process.env.PRIVATE_KEY_DEV || "your private key"
 ...
 module.exports = {
     ...
     networks: {
         ...
         localhost: {
             ...
             accounts: [PRIVATE_KEY_DEV] // Insert your private key here
         },
         kovan: {
             url: KOVAN_RPC_URL,
